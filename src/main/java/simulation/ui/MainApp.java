...
public class MainApp extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        // Wrap Canvas in a Pane to make it resizable and bind dimensions
        javafx.scene.layout.Pane canvasWrapper = new javafx.scene.layout.Pane(gridCanvas);
        gridCanvas.widthProperty().bind(canvasWrapper.widthProperty());
        gridCanvas.heightProperty().bind(canvasWrapper.heightProperty());
        gridCanvas.widthProperty().addListener((o, old, val) -> gridCanvas.resetZoom());
        gridCanvas.heightProperty().addListener((o, old, val) -> gridCanvas.resetZoom());
